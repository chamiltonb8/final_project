---
title: "Tutorial: How to use the stat386stonks Package"
engine: python
execute:
...
2. create a `.env` file in your root directory and list it in a `.gitignore` file. Make sure that the call to the API in the .env file looks like this:
